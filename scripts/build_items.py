...
# --- science / history / geography (grade 4) ---
items += [
    item("sc-01", "animal_adaptations", 1, "Why does a polar bear have thick fur?",
         [("a", "To stay warm in the cold"), ("b", "To swim faster"), ("c", "To look bigger"), ("d", "To climb ice better")], "a",
         "Think about where a polar bear lives.", "Thick fur keeps heat in, which matters in the Arctic cold."),
    item("sc-02", "animal_adaptations", 1, "What helps a duck float and stay dry?",
         [("a", "Oily feathers"), ("b", "Heavy bones"), ("c", "Big feet"), ("d", "A loud quack")], "a",
         "Water rolls right off a duck's back. What is on its back?", "The oil on a duck's feathers pushes water away."),
    item("sc-03", "animal_adaptations", 2, "Which of these is camouflage?",
         [("a", "White fur that matches the snow"), ("b", "Running very fast"), ("c", "Sharp teeth"), ("d", "A loud roar")], "a",
         "Camouflage means blending in so you are hard to see.", "Fur that matches the snow hides an animal from hunters and prey."),
    item("sc-04", "animal_adaptations", 3, "Why do many birds fly south in winter?",
         [("a", "To find food and warmer weather"), ("b", "To race each other"), ("c", "Because trees fall down"), ("d", "To build snow nests")], "a",
         "What is hard to find here in winter?", "Winter makes food scarce, so birds travel to warmer places that have more."),
    item("sc-05", "animal_adaptations", 4, "A desert fox has very big ears. What job do they do?",
         [("a", "They let out extra heat to cool the fox"), ("b", "They help it hear underwater"), ("c", "They dig sand"), ("d", "They scare enemies away")], "a",
         "Deserts are very hot. Big ears have lots of skin for a reason.", "Heat escapes through the big ears, which keeps the fox cooler."),
    item("sc-06", "animal_adaptations", 5, "Which of these is learned, not something an animal is born knowing?",
         [("a", "A dog sitting when you say sit"), ("b", "A spider spinning a web"), ("c", "A chick pecking for seeds"), ("d", "A bear growing winter fur")], "a",
         "Which one needs a person to teach it?", "Dogs learn to sit from practice with people. The others happen on their own."),

    item("hi-01", "sea_explorers", 1, "What did explorers sail across to find new lands?",
         [("a", "Oceans"), ("b", "Deserts"), ("c", "Mountains"), ("d", "Forests")], "a",
         "Explorers travelled by ship.", "Ships cross oceans, and that is how explorers reached faraway lands."),
    item("hi-02", "sea_explorers", 1, "A pirate flag with a skull was meant to…",
         [("a", "Scare other ships"), ("b", "Say hello"), ("c", "Show fish for sale"), ("d", "Celebrate a birthday")], "a",
         "How would you feel seeing that flag sail toward you?", "Pirates flew the skull flag so ships would give up without a fight."),
    item("hi-03", "sea_explorers", 2, "Why did explorers bring a compass on their ships?",
         [("a", "To know which direction they were sailing"), ("b", "To cook their food"), ("c", "To fix the sails"), ("d", "To trade it for gold")], "a",
         "In the middle of the ocean, every direction looks the same.", "A compass always points north, so sailors could keep their direction."),
    item("hi-04", "sea_explorers", 3, "Long voyages were dangerous because ships could run out of…",
         [("a", "Fresh food and water"), ("b", "Cannonballs"), ("c", "Parrots"), ("d", "Gold coins")], "a",
         "What do people need every single day to stay alive?", "There were no stores at sea. Ships had to carry all their food and water."),
    item("hi-05", "sea_explorers", 4, "Why did sailors start eating oranges and limes on long trips?",
         [("a", "The fruit kept them from getting a sickness called scurvy"), ("b", "To feed the fish"), ("c", "To clean the decks"), ("d", "To make orange paint")], "a",
         "It has to do with staying healthy.", "Oranges and limes have vitamin C, which stopped a sickness called scurvy."),
    item("hi-06", "sea_explorers", 5, "What does the word voyage mean?",
         [("a", "A long journey, especially by sea"), ("b", "A pirate's hat"), ("c", "A kind of storm"), ("d", "A treasure chest")], "a",
         "Explorers went on long voyages across the ocean.", "A voyage is a long journey, and explorers made theirs by ship."),

    item("ge-01", "maps_continents", 1, "How many continents are there on Earth?",
         [("a", "7"), ("b", "3"), ("c", "12"), ("d", "50")], "a",
         "Count them: Africa, Antarctica, Asia, Australia, Europe, North America, South America.", "Earth has seven continents."),
    item("ge-02", "maps_continents", 1, "On most maps, which direction is at the top?",
         [("a", "North"), ("b", "South"), ("c", "East"), ("d", "West")], "a",
         "Think of where the N points on a compass rose.", "Mapmakers usually put north at the top."),
    item("ge-03", "maps_continents", 2, "What does a map key tell you?",
         [("a", "What the little symbols on the map mean"), ("b", "How old the map is"), ("c", "What the weather will be"), ("d", "Who built the roads")], "a",
         "The key unlocks the map's secret code of symbols.", "The key explains each symbol, like a tree for a forest or a tent for a campsite."),
    item("ge-04", "maps_continents", 3, "Which continent is the United States part of?",
         [("a", "North America"), ("b", "Africa"), ("c", "Asia"), ("d", "Europe")], "a",
         "It is in the name of the continent.", "The United States is in North America, along with Canada and Mexico."),
    item("ge-05", "maps_continents", 4, "The compass rose on a map shows…",
         [("a", "The directions: north, south, east, and west"), ("b", "Where flowers grow"), ("c", "How far away the sun is"), ("d", "The flags of countries")], "a",
         "It is a star shape with letters like N and S.", "The compass rose points out the four directions on the map."),
    item("ge-06", "maps_continents", 5, "On a treasure map, what does the X usually mark?",
         [("a", "The spot where the treasure is hidden"), ("b", "A dangerous flower"), ("c", "The captain's name"), ("d", "Which way is north")], "a",
         "X marks the spot!", "On treasure maps, the X marks where the treasure is buried."),
]
